...
extension UIView {
    ...
    @discardableResult
      open func padStartAndCenterY(withPadding padding : CGFloat) -> UIView {
          guard let superview = self.superview else { return self }
          self.anchor(top: nil, leading: superview.leadingAnchor, bottom: nil, trailing: nil, padding: UIEdgeInsets(top: 0, left: padding, bottom: 0, right: 0))
          self.centerYToSuperview()
          return self
      }
      
      @discardableResult
      open func padLeftAndCenterY(withPadding padding : CGFloat, leadingAnchor : NSLayoutXAxisAnchor) -> UIView {
          self.anchor(top: nil, leading: leadingAnchor, bottom: nil, trailing: nil, padding: UIEdgeInsets(top: 0, left: padding, bottom: 0, right: 0))
          self.centerYToSuperview()
          return self
      }
      
      @discardableResult
      open func padRightAndCenterY(withPadding padding : CGFloat, trailingAnchor : NSLayoutXAxisAnchor) -> UIView {
          self.anchor(top: nil, leading: nil, bottom: nil, trailing: trailingAnchor, padding: UIEdgeInsets(top: 0, left: 0, bottom: 0, right: padding))
          self.centerYToSuperview()
          return self
      }
      
      @discardableResult
      open func padEndAndCenterY(withPadding padding : CGFloat) -> UIView {
          guard let superview = self.superview else { return self }
          self.anchor(top: nil, leading: nil, bottom: nil, trailing: superview.trailingAnchor, padding: UIEdgeInsets(top: 0, left: 0, bottom: 0, right: padding))
          self.centerYToSuperview()
          return self
      }
